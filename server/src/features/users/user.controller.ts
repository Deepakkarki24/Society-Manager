...
export const getUsers = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const filter: Record<string, unknown> = { ...getSocietyFilter(req), isActive: true };
...
export const addFamilyMember = asyncHandler(async (req: AuthRequest, res: Response) => {
...
export const removeFamilyMember = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  user.familyMembers = user.familyMembers.filter(
    (m) => String((m as { _id?: { toString(): string } })._id) !== req.params.memberId
  );
  await user.save();
...
export const getMaintenanceStaff = asyncHandler(async (req: AuthRequest, res: Response) => {
