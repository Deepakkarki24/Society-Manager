...
exports.generateInvoices = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
...
exports.getPayments = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    res.json({ success: true, ...(0, pagination_1.paginatedResponse)(payments, total, page, limit) });
});
...
exports.getPaymentSummary = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const societyId = req.user.society;
