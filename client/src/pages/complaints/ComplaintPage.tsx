                        ...
                        <table className="w-full text-left text-sm">
                            <thead>
                                <tr className="border-b border-border-subtle">
                                    <th className="pb-3 text-white pl-3 font-medium">Title</th>
                                    <th className="pb-3 text-white font-medium">Category</th>
                                    <th className="pb-3 text-white font-medium">Priority</th>
                                    <th className="pb-3 text-white font-medium">Status</th>
                                    <th className="pb-3 text-white font-medium">Date</th>
                                </tr>
                            </thead>
                            <tbody>
                                {complaints && complaints.map((c) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-3 max-sm:px-4 capitalize text-white">{c.category}</td>
                                        <td className="py-3 max-sm:px-4 capitalize text-white">{c.priority}</td>
                                        <td className="py-3 max-sm:px-4">
                                            <Badge status={c.status} />
                                        </td>
                                        <td className="py-3 max-sm:px-4 text-text-muted">
